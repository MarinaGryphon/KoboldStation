...
/obj/item/reagent_containers/blood/attackby(obj/item/weapon/P as obj, mob/user as mob)
	..()
	if (P.ispen())
...
/obj/item/reagent_containers/blood/ripped/attackby(obj/item/weapon/P as obj, mob/user as mob)
