/obj/machinery/sleeper
	...
	var/tmp/list/available_chemicals = list("norepinephrine" = "Norepinephrine", "stoxin" = "Soporific", "paracetamol" = "Paracetamol", "dylovene" = "Dylovene", "dexalin" = "Dexalin")
	var/obj/item/reagent_containers/glass/beaker = null
	var/tmp/filtering = 0
	var/tmp/allow_occupant_types = list(/mob/living/carbon/human)
	var/tmp/disallow_occupant_types = list()
	var/tmp/pump
